...
<div>
    ...
    <form class="mb-3" method="POST" action="kolding.php">
   
    <button type="submit" class="btn btn-primary">kolding</button>
  </form>
</div>
<div>
    ...
    <div>
            <table class="table table-sm table-dark">
                <thead>
                    ...
                    <th scope="col">SolOpgang</th>
                    <th scope="col">SolNedgang</th>
                    </tr>
                </thead>
            <tbody>
            <?php
          $latitude = 55.6728979;
          $longitude = 12.5626768;
            ...
            include('./calculateDag.php');
             ...
             $weekendDay = $weekdag->currentDay(1);
    ...
    <div >
            ...
            <form action="datePickKbh.php" method="POST">
